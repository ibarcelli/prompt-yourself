# Prompt Yourself — Estructura Interna del Prompt Diario

## 1. Estructura de 4 Partes

El usuario recibe el prompt como flujo continuo. La estructura interna es invisible para él — solo la usa el motor de generación.

---

### Parte 1: Anclaje

**Propósito psicológico/neurológico**: Activa el self-referential processing en la corteza prefrontal medial. Al declarar identidad en primera persona y presente simple, el cerebro activa las mismas redes neuronales que usa para procesar el sentido del yo. Es el "login" al sistema operativo interno: le dice al inconsciente quién es esta persona antes de darle instrucciones.
...
- No incluir acciones ni metas — solo identidad pura.
...
### Parte 2: Declaración de Estado

**Propósito psicológico/neurológico**: Aprovecha el priming cognitivo y la neuroplasticidad dependiente de experiencia. Al declarar estados en presente simple, el cerebro genera patrones de activación neural consistentes con esa realidad declarada. En estado alfa (8-12 Hz), estas declaraciones penetran más profundamente porque el filtro crítico del consciente está atenuado. Apunta directamente al gap detectado por el sistema en la dimensión que toca ese día.
...
- Incluir al menos una declaración que involucre emoción (sentir, experimentar) y una que involucre acción o resultado.
...
### Parte 3: Visualización Dirigida

**Propósito psicológico/neurológico**: Activa la simulación motora y sensorial en la corteza premotora y las áreas de asociación sensorial. La neurociencia ha demostrado que visualizar una acción activa las mismas redes neuronales que ejecutarla (mirror neuron system). Esta parte lleva al usuario a una escena concreta y específica de su día o su vida alineada a su visión, generando un ensayo mental que fortalece las vías neuronales del comportamiento deseado.
...
### Parte 4: Cierre de Integración

**Propósito psicológico/neurológico**: Sella el estado activado mediante una declaración de presente absoluto. Funciona como un ancla temporal que le dice al cerebro "esto no es futuro, esto es ahora". En términos de neuroplasticidad, consolida el patrón neural activado en las partes anteriores. En términos de priming, establece el estado emocional base con el que el usuario entra a su día.
...
## 2. Variaciones por Nivel de Usuario

### Nivel 1 — Curioso

El usuario sabe que "algo hay" pero no tiene práctica ni framework. Nunca ha meditado consistentemente. Puede sentirse escéptico o simplemente curioso.

**Lenguaje**: Simple, cotidiano, sin jerga técnica ni espiritual. Palabras que cualquiera entiende.
**Profundidad**: Superficial y accesible. Declaraciones directas sobre estados deseados concretos y tangibles.
**Intensidad**: Baja-media. El prompt no debe sentirse "demasiado" ni generar resistencia interna. Declaraciones que el usuario pueda aceptar sin fricción.
**Visualización**: Escenas ultra cotidianas y realistas — la mañana, el trabajo, la familia.
**Emociones**: Calma, claridad, seguridad, satisfacción. No éxtasis ni estados alterados.
**Evitar**: Campo cuántico, frecuencias, activación, neuroplasticidad, estados de consciencia, ondas cerebrales. Cualquier término que suene a "clase" o "gurú".

### Nivel 2 — Practicante

El usuario ha leído libros de desarrollo personal, ha hecho meditaciones guiadas, conoce conceptos como visualización y priming. Tiene práctica intermitente.

**Lenguaje**: Puede incluir terminología de desarrollo personal y, según el marco, términos metafísicos o científicos básicos.
**Profundidad**: Media. Puede referirse a estados internos, patrones mentales y conexiones entre mente y resultados.
**Intensidad**: Media. El prompt puede ser más directo y activador. El usuario no se asusta ante declaraciones fuertes.
**Visualización**: Escenas que incluyen estados internos además de acciones externas. Puede describir sensaciones energéticas o cognitivas.
**Emociones**: Empoderamiento, gratitud profunda, libertad, amor propio.
**Puede incluir (según marco)**: Visualización activa, reprogramación, patrones, energía, conexión.

### Nivel 3 — Avanzado

El usuario tiene práctica regular. Conoce técnicas específicas (Silva, Dispenza, meditación profunda). Ha experimentado estados alterados de consciencia. Busca profundidad, no introducción.

**Lenguaje**: Sofisticado y preciso. Según el marco, puede usar terminología avanzada sin explicarla.
**Profundidad**: Alta. Puede referirse a estados de consciencia, campos de posibilidad, neuroplasticidad avanzada, coherencia cardíaca, estados theta.
**Intensidad**: Alta. Declaraciones potentes, activadoras, que presuponen maestría. El usuario espera ser retado, no guiado suavemente.
**Visualización**: Escenas que combinan lo externo con lo interno. Puede incluir experiencias de expansión, conexión con algo mayor, o estados peak.
...
## 3. Variaciones por Marco

### Marco Metafísico

**Vocabulario permitido**: campo, energía, frecuencia, activación, universo, manifestación, cuántico, vibración, campo cuántico, campo de posibilidades, campo unificado, salto cuántico, alineación, expansión, fuente, creación consciente, intención pura, resonancia.
...
- Siempre primera persona, presente simple declarativo.
- Siempre emociones en la parte alta de la escala de Hicks (gratitud, libertad, amor, empoderamiento, pasión, alegría, conocimiento, entusiasmo).
- Nunca segunda persona, nunca futuro, nunca condicional.
- El prompt debe sentirse como el propio inconsciente hablándole al consciente — nunca como un coach, terapeuta o app.
- La estructura de 4 partes se respeta siempre, independientemente del marco.

---

## 4. Ejemplos Completos (6 Prompts)

Cada ejemplo usa un perfil ficticio realista. El prompt se presenta como flujo continuo — el usuario no ve separaciones.

---

### Ejemplo 1: Nivel 1 + Marco Científico
...
### Ejemplo 2: Nivel 1 + Marco Metafísico
...
### Ejemplo 3: Nivel 2 + Marco Científico
...
### Ejemplo 4: Nivel 2 + Marco Metafísico
...
### Ejemplo 5: Nivel 3 + Marco Científico
...
### Ejemplo 6: Nivel 3 + Marco Metafísico
...
5. **No repetir frases exactas en una misma semana**. El motor debe trackear los prompts generados en los últimos 7 días y evitar repetición literal de frases.
6. **Calibrar intensidad según nivel**. Nivel 1 recibe declaraciones suaves y accesibles. Nivel 3 recibe declaraciones potentes y activadoras. El nivel se respeta siempre.
7. **Respetar marco elegido por el usuario**. Marco científico no usa vocabulario metafísico. Marco metafísico puede usar vocabulario de activación y campo. No mezclar marcos.
8. **Longitud total del prompt: 6-10 líneas máximo**. El prompt completo (las 4 partes juntas) no debe exceder 10 líneas. La brevedad es poder.
...
Un prompt de Prompt Yourself **NUNCA** debe:

1. **Usar segunda persona**. Prohibido: "tú deberías", "te mereces", "tú puedes", "te invito a". El prompt no habla AL usuario — ES el usuario.
2. **Usar futuro**. Prohibido: "vas a lograr", "lograrás", "conseguirás", "pronto tendrás". El futuro implica que no es ahora. Todo es presente.
3. **Usar condicional**. Prohibido: "podrías", "serías capaz", "deberías". El condicional implica duda. El prompt declara certeza.
4. **Incluir preguntas**. Prohibido: "¿qué pasaría si...?", "¿estás listo?", "¿te imaginas?". Las preguntas abren espacio a la duda. El prompt afirma.
5. **Sonar motivacional genérico**. Prohibido: "¡tú puedes!", "el éxito te espera", "no te rindas", "cree en ti". Esto es lenguaje de poster de oficina, no de reprogramación profunda.
6. **Mencionar la app o el proceso**. Prohibido: "este prompt te ayudará", "al leer esto tu mente...", "Prompt Yourself te guía". La app es invisible. El usuario no debe sentir que una herramienta le habla.
7. **Usar imperativos**. Prohibido: "respira profundo", "cierra los ojos", "repite esto". El prompt no da órdenes — declara estados.
